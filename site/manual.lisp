...
/usr/include/glob.h:166:extern void globfree64 (glob64_t *__pglob) __THROW;")
    (:blockquote :class "small" "If you need to search with a whitespace, use \"+\" instead.")
...
60498")
    ...
    (:blockquote :class "small" "If you get an error saying " (:code "fatal: too many results to grep") ", it's because the results were found in more than 100 files, which makes grep uncomfortable to use. If you decide to go above, you can set the limit in the " (:code "BL_MAX_GREP_RESULTS") " environment variable.")
